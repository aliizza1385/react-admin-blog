...
import { Create, CreateProps, Datagrid, ImageField, ImageInput, ReferenceArrayInput, ReferenceInput, ReferenceManyField, SimpleForm, TextField, TextInput, required } from 'react-admin';
